...
final class Day4Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day4.solvePartOne(from: testInput), 2)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day4.solvePartOne(from: solutionInput), 242)
    }
...
"""
        ...
        XCTAssertEqual(Day4.solvePartTwo(from: allInvalid), 0)
        XCTAssertEqual(Day4.solvePartTwo(from: allValid), 4)
    }

    func test_part2_solution() {
        XCTAssertEqual(Day4.solvePartTwo(from: solutionInput), 186)
    }
}
