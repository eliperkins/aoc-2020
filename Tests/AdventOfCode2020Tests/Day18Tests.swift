...
final class Day18Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day18.solve("1 + 2 * 3 + 4 * 5 + 6"), 71)
        XCTAssertEqual(Day18.solve("1 + (2 * 3) + (4 * (5 + 6))"), 51)
        XCTAssertEqual(Day18.solve("2 * 3 + (4 * 5)"), 26)
        XCTAssertEqual(Day18.solve("5 + (8 * 3 + 9 + 3 * 4 * 3)"), 437)
        XCTAssertEqual(Day18.solve("5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))"), 12240)
        XCTAssertEqual(Day18.solve("((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2"), 13632)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day18.solvePartOne(from: solutionInput), 1402255785165)
    }

    func test_part2_test() throws {
        try XCTSkipIf(true)
        XCTAssertEqual(Day18.solve2("1 + 2 * 3 + 4 * 5 + 6"), 231)
        XCTAssertEqual(Day18.solve2("1 + (2 * 3) + (4 * (5 + 6))"), 51)
        XCTAssertEqual(Day18.solve2("5 + (8 * 3 + 9 + 3 * 4 * 3)"), 1445)
        XCTAssertEqual(Day18.solve2("5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))"), 669060)
        XCTAssertEqual(Day18.solve2("((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2"), 23340)
    }

    func test_part2_solution() throws {
        try XCTSkipIf(true)
        XCTAssertEqual(Day18.solvePartTwo(from: solutionInput), 1)
    }
}
