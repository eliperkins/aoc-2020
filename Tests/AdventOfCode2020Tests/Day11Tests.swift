...
final class Day11Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day11.solvePartOne(from: testInput), 37)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day11.solvePartOne(from: solutionInput), 2438)
    }

    func test_part2_test() {
        XCTAssertEqual(Day11.solvePartTwo(from: testInput), 26)
    }

    func test_part2_solution() {
        XCTAssertEqual(Day11.solvePartTwo(from: solutionInput), 2174)
    }
}
