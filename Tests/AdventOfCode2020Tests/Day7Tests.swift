...
final class Day7Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day7.solvePartOne(from: testInput), 4)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day7.solvePartOne(from: solutionInput), 326)
    }

    func test_part2_test() {
        XCTAssertEqual(Day7.solvePartTwo(from: testInput), 32)
        XCTAssertEqual(Day7.solvePartTwo(from: test2Input), 126)
    }

    func test_part2_solution() {
        XCTAssertEqual(Day7.solvePartTwo(from: solutionInput), 5635)
    }
}
