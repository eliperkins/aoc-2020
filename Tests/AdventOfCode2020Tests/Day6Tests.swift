...
final class Day6Tests: XCTestCase {
    func test_part1_test() {
        XCTAssertEqual(Day6.solvePartOne(from: testInput), 11)
    }

    func test_part1_solution() {
        XCTAssertEqual(Day6.solvePartOne(from: solutionInput), 7283)
    }

    func test_part2_test() {
        XCTAssertEqual(Day6.solvePartTwo(from: testInput), 6)
    }

    func test_part2_solution() {
        XCTAssertEqual(Day6.solvePartTwo(from: solutionInput), 3520)
    }
}
